...
namespace Компилятор
{
    ...
    class Errors//класс для ошибок
    {
        static public Dictionary<int, string> err = new Dictionary<int, string>()
        {
            ...
            {198, "несоответствие количества параметров параметрапроцедуры (функции)"},
